...
export function getIcon(weatherCode: number | null | undefined, isDay: boolean | number = true, _cloudCover: number | null = null): string {
    if (weatherCode === null || weatherCode === undefined) return cloudyIcon;
