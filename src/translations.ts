export interface Translation {
    ...
    switchToDark: string;
    switchToFahrenheit: string;
    switchToCelsius: string;
    switchToFinnish: string;
...
export const translations: Record<string, Translation> = {
    en: {
        ...
        switchToFahrenheit: "Vaihda Fahrenheitiin",
        switchToCelsius: "Vaihda Celsiukseen",
        switchToFinnish: "Vaihda suomeen",
        switchToEnglish: "Vaihda englantiin",
