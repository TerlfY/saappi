...
const fetchWeather = async ({ queryKey }) => {
  ...
  const mainOptions = {
    ...
    params: {
      latitude: lat,
      longitude: lon,
      hourly: "temperature_2m,relativehumidity_2m,apparent_temperature,weathercode,windspeed_10m,windgusts_10m,winddirection_10m,uv_index,cloudcover,precipitation_probability,precipitation,is_day",
      daily: "weathercode,temperature_2m_max,temperature_2m_min,sunrise,sunset,precipitation_probability_max,precipitation_sum",
      timezone: "auto",
      windspeed_unit: "ms",
      forecast_days: 16,
    },
